...
if __name__ == "__main__":
    ...
    f = open(os.path.join(os.path.dirname(__file__), 'lists/fileparts.txt'), 'r')
    fileparts = f.readlines()
    f.close()

    f = open(os.path.join(os.path.dirname(__file__), 'lists/files.txt'), 'r')
    files = f.readlines()
    f.close()

    f = open(os.path.join(os.path.dirname(__file__), 'lists/augment.txt'), 'r')
